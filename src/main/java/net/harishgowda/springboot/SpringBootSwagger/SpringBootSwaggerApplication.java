package net.harishgowda.springboot.SpringBootSwagger;
...
public class SpringBootSwaggerApplication {
	...
	public Docket swaggerConfigs() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("net.harishgowda"))
				.build()
	...
	public ApiInfo createApiInfo(){
		...
		return new ApiInfo("Employee information api",
				"Simple REST API for employees",
				 "1.0",
				"Free to use",
				new Contact("Harish Gowda","https://harishgowda.net","hi@harishgowda.net"),
				"API license",
				"https://harishgowda.net",
